...
let deck_off = vec3(1.3, 1.2, -1.3)
let settle_at = vec3(119.0, 3.0, -129.0)

var has_ridden = false
var ferry_seen_away = false
var line = 0
let lines = [
  "Help! We are marooned out here with no way across the water.",
  "There is a camp with hot soup to the northwest. If only I could swim!",
]
