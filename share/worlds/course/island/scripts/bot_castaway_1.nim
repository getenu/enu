...
let settle_at = vec3(120.0, 3.0, -127.0)

var has_ridden = false
var ferry_seen_away = false
var line = 0
let lines = [
  "Shipwrecked! I've been stuck on this rock for days.",
  "They say the camp on the peninsula has hot soup. I'd swim... but I can't.",
]
