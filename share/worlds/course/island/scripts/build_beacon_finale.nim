...
# Finale progress beacon: same tall post + lantern as the site beacons. The
# course director kicks our glow when E6 + E7 are done; the lantern turns
# green and we take over pulsing. That moment also unlocks flight, so we
# carry the "sky is yours" sign.
