...
gdobj PlayerNode of KinematicBody:
  var
    ...
    # Written by GUI's input handler (which owns jump and run events); read by
    # calculate_velocity — jump_down for the hold-to-float reduced gravity,
    # alt_speed for hold-to-switch-speed.
    alt_speed*: bool
    jump_down*: bool
