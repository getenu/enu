---
description: Procedural and animated Enu builds via turtle-style movement and the loop: state machine — spirals, towers, fractals, doors, platforms. Use when writing or animating a build script.
---
