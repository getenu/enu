---
description: Apply Enu script/JSON changes via hot-reload and verify them with screenshots and bounds checks. Use when iterating on a build and confirming it worked.
---
